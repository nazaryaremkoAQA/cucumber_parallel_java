...
//    }
//
//    public static<T extends BasePage> T init(Class<T> cl) {
//        return (T) PageFactory.initElements(driver, cl);
//    }
//
//    /**********************************************************************************
//     **CLICK METHODS
...
//
//
//    public void hoverOnWebElement(WebElement locator, WebDriver driver, int timeout) {
//        try {
...
//            System.out.println("Successfully hover on the WebElement, using locator: " + "<" + locator + ">" + ", using a custom Timeout of: " + timeout);
//        } catch (Exception e) {
//            System.out.println("Unable to hover on the WebElement, using locator: " + "<" + locator + ">" + ", using a custom Timeout of: " + timeout);
//            Assert.fail("Unable to hover on the WebElement, Exception: " + e.getMessage());
//        }
//    }
//
//    public void waitElementIsVisible(WebElement locator, int timeout) {
//        try {
//            final WebDriverWait customWait = new WebDriverWait(driver, timeout);
//            customWait.until(ExpectedConditions.visibilityOf(locator));
//            System.out.println("Successfully find the WebElement, using locator: " + "<" + locator + ">" + ", using a custom Timeout of: " + timeout);
//        } catch (Exception e) {
//            System.out.println("Unable to find the WebElement, using locator: " + "<" + locator + ">" + ", using a custom Timeout of: " + timeout);
